...
DEFAULT_CONTRACT_ADDRESS = '0x831A68CD2070d988f5baB3003cE7fa65A9B1ca78'
...
def load_contract_config():
    ...
    try:
        ...
        checksum_address = Web3.to_checksum_address(DEFAULT_CONTRACT_ADDRESS)
    return {
